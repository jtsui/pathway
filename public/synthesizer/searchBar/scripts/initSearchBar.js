...
(function ($) {
    $(function () {
        ...
        var showHelpPane = false; //typeof sbarAttr.showHelpPane !== 'undefined' ?  sbarAttr.showHelpPane : 'true';
        ...
        $('head').append("<link href='http://pathway.berkeley.edu/synthesizer/searchBar/styles/searchBar.css' rel='stylesheet'>"); 
        ...
        var searchbarHTML  = "<div id='searchBarBackground'></div><div class='ui-widget'>";
            ...
            searchbarHTML += "<input id='searchBar' name='searchBar' type='text' placeholder='Enter Chemical Act ID, Name, or Standard InChI' />";
...
/*
            ...
            searchbarHTML += "<li><a href=''>About Act</a></li>";
          ...
          */ 
            ...
            $searchBarContainer.fadeIn('slow', function() {
                ...
                if(showHelpPane) { 
                  ...
                  $.getScript("http://pathway.berkeley.edu/synthesizer/searchBar/scripts/searchBar.js");
                  
                  // load the activity log script
                  //$.getScript("http://bussedesignstage.com/ajax/cl01.1/searchBar/scripts/activityLog.js");
                  $.getScript("http://pathway.berkeley.edu/synthesizer/searchBar/scripts/activityLog.js");
                  $.getScript("http://pathway.berkeley.edu/synthesizer/searchBar/scripts/searchGraph.js");
