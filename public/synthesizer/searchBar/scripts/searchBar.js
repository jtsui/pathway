...
(function ($) {
    $(function () {
        ...
        function submitSearchTerm() {
            ...
            //var searchSubmitURL = "http://pathway.berkeley.edu/synthesizer/scripts/php/formSubmitted.php";
            ...
            $.ajax({
                ...
                success: function(data){
                    searchGraph($SearchBar.val());

                /*data["chemid"] = $SearchBar.val();
                if (data["chemid"]) { 
                document.getElementById('searchResult').src = "http://pathway.berkeley.edu:28000/getpaths?chemid=" + data["chemid"] + "&thresh=50&nodelimit=30";
		}*/
